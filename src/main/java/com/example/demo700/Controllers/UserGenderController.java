...
public class UserGenderController {
    ...
    public ResponseEntity<?> add(@RequestBody UserGender userGender) {
        try {
            return ResponseEntity.status(HttpStatus.CREATED)
                    .body(userGenderService.addUserGender(userGender));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> update(
            @RequestBody UserGender userGender,
            @PathVariable String id,
            @PathVariable String userId) {
        try {
            return ResponseEntity.ok(
                    userGenderService.updateUserGender(userGender, userId, id));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(e.getMessage());
        }
    }
    ...
    public ResponseEntity<?> findByUserId(@PathVariable String userId) {
        try {
            return ResponseEntity.ok(
                    userGenderService.findByUserId(userId));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(e.getMessage());
        }
    ...
    public ResponseEntity<?> findByGender(@PathVariable Gender gender) {
        try {
            return ResponseEntity.ok(
                    userGenderService.findByGender(gender));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(e.getMessage());
        }
    ...
    public ResponseEntity<?> delete(
        ...
        try {
            boolean deleted =
                    userGenderService.deleteUserGender(id, userId);
    ...
    public ResponseEntity<?> findAllAthletes(@PathVariable Gender gender) {
        try {
            List<Athelete> list =
                    userGenderService.findAllAthlete(gender);
    ...
    public ResponseEntity<?> findAllCoaches(@PathVariable Gender gender) {
        try {
            List<Coach> list =
                    userGenderService.findAllCoach(gender);
            return ResponseEntity.ok(list);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(e.getMessage());
    ...
    public ResponseEntity<?> findAllScouts(@PathVariable Gender gender) {
        try {
            List<Scouts> list =
                    userGenderService.findAllScouts(gender);
            return ResponseEntity.ok(list);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(e.getMessage());
    ...
    public ResponseEntity<?> findAllVenueOwners(@PathVariable Gender gender) {
        try {
            List<Owner> list =
                    userGenderService.findAllVenueOwner(gender);
            return ResponseEntity.ok(list);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(e.getMessage());
    ...
    public ResponseEntity<?> findAllGymTrainers(@PathVariable Gender gender) {
        try {
            List<User> list =
                    userGenderService.findAllGymTrainer(gender);
            return ResponseEntity.ok(list);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(e.getMessage());
    ...
    public ResponseEntity<?> findAllGymOwners(@PathVariable Gender gender) {
        try {
            List<User> list =
                    userGenderService.findAllGymOwner(gender);
            return ResponseEntity.ok(list);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(e.getMessage());
    ...
    public ResponseEntity<?> findAllTeamOwners(@PathVariable Gender gender) {
        try {
            List<TeamOwner> list =
                    userGenderService.findAllTeamOwner(gender);
            return ResponseEntity.ok(list);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(e.getMessage());
