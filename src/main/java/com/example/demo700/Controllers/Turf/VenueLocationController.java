...
public class VenueLocationController {
	...
	public ResponseEntity<?> seeAllVenueLocation() {
		...
		try {
			...
			List<VenueLocationResponse> list = venueLocationService.seeAllVenueLocation();
	...
	public ResponseEntity<?> searchVenueLocation(@RequestParam String venueLocation) {
		...
		try {
			...
			List<VenueLocationResponse> list = venueLocationService.searchVenueLocationByName(venueLocation);
	...
	public ResponseEntity<?> searchVenueLocationById(@RequestParam String venueLocationId) {
		...
		try {
			...
			VenueLocationResponse list = venueLocationService.searchVenueLocation(venueLocationId);
	...
	@PutMapping("/update")
	public ResponseEntity<?> updateVenueLocation(@RequestParam String venueLocationId,
			@RequestBody VenueLocation updatedVenueLocation, @RequestParam String userId) {

		try {

			VenueLocation venueLocation = venueLocationService.updateVenueLocation(venueLocationId,
					updatedVenueLocation, userId);
