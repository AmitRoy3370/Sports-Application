...
public class TeamJoinRequestController {
    ...
    public ResponseEntity<?> updateRequestStatus(@RequestBody TeamJoinRequest teamJoinRequest,
        ...
        try {
            TeamJoinRequest updatedRequest = teamJoinRequestService.updateRequestStatus(teamJoinRequest, userId, requestId);
    ...
    public ResponseEntity<?> handleJoinResponse(@RequestParam String teamJoinRequestId, @RequestParam String userId,
    	...
    	try {
    		...
    		boolean yes = teamJoinRequestService.handleJoinResponse(teamJoinRequestId, userId, AtheletesTeamJoiningResponse.valueOf(atheleteResponse));
    ...
    public ResponseEntity<?> getRequestsByStatus(@PathVariable TeamJoinRequestStatus status) {
        try {
            List<TeamJoinRequest> requests = teamJoinRequestService
                    .seeAllTeamJoinRequest()
                    .stream()
